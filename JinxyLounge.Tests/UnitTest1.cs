...
//            // Act
//            ProductListViewModels result = (ProductListViewModels)controller.List(null, 2).Model;
...
//            controller.PageSize = 3;
//            // Action
//            Product[] result = ((ProductListViewModels)controller.List("Cat2", 1).Model)
//            .Products.ToArray();
//            // Assert
...
//            int res1 = ((ProductListViewModels)target
//            .List("Cat1").Model).PagingInfo.TotalItems;
//            int res2 = ((ProductListViewModels)target
//            .List("Cat2").Model).PagingInfo.TotalItems;
//            int res3 = ((ProductListViewModels)target
//            .List("Cat3").Model).PagingInfo.TotalItems;
//            int resAll = ((ProductListViewModels)target
